...
export default function ProductDetails({
  ...
  return (
    <div className="py-10 md:py-16 lg:py-25" id="product_details">
      <Container>
          ...
          <div className="flex-1">
            ...
            <div className="mt-8 rounded-lg bg-[#F3F3F8] p-5 sm:p-8">
              ...
              <div className="mt-6 flex items-center gap-2 text-[#474651]">
                <HiOutlineInformationCircle className="size-6 shrink-0" />
                <p>All items are officially signed and delivered within 30 days.</p>
              </div>
            </div>

            {/* Authenticity */}
            <div className="mt-8 flex rounded-lg border-l-4 border-[#5A38F5] bg-[#F3F3F8] p-5 sm:p-8">
              <div className="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-white text-[#F5C542]">
                <FaAward />
              </div>
              <div className="ml-4">
        ...
        {/* ── Bottom section: product details + accordion ── */}
        <div className="mt-16 md:mt-20 lg:mt-25 flex flex-col lg:flex-row gap-10 lg:gap-16">
